...
class PygameIOAdapter:
    ...
    def draw_rect(self, surface: Surface, color: Tuple[int, int, int], 
                  rect: Rect, width: int = 0) -> Rect:
        """Draw a rectangle.
    ...
    def draw_circle(self, surface: Surface, color: Tuple[int, int, int],
                    center: Tuple[int, int], radius: int, width: int = 0) -> Rect:
        """Draw a circle.
    ...
    def draw_line(self, surface: Surface, color: Tuple[int, int, int],
                  start_pos: Tuple[int, int], end_pos: Tuple[int, int], width: int = 1) -> Rect:
        """Draw a line.
